...
### Плохие практики по использованию систем контейнеризации:
1. Не следует создавать слишком большие контейнеры, так как они будут требовать больше времени на сборку, им будет труднее управлять, а также может приводить к неэффективному использованию ресурсов.
2. В одном контейнере следует разворачивать лишь один процесс. Одновременный запуск нескольких сервисов в одном контейнере будет приводить к сложностям при их эксплуатации и обновлениях.
## Вывод
